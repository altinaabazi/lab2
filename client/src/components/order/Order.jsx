...
//stripe e blendes
const stripePromise = loadStripe("pk_test_51RVuogPsnrCOJx0tCFLSM7RXWEvUFRY4VfAV2SqQYpzh0FqLBhWiLrX0TTbzIU8QumNlRB31OIkkaPpxlaJ4BEk300cODgzmsv");
  ...
  if (!currentUser) {
    return (
      <div className="order-popup">
        <p>To do your order please Login</p>
